...
app.get('/',(req,res)=>{
    res.end(`<div style="display:flex; height:100vh; align-items:center; justify-content:center; background:gray;"><h1 style="color:white;text-align:center;font-size:40px; background:black; padding:20px; border-radius:10px">This is Day 1 Project of #7Day #7ProjectsChallenge</h1></div>`)
})
